					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								...
								<li><a href="checkout.htm"><i class="fa fa-crosshairs"></i>
										Checkout</a></li>
								<li><a href="cart.htm"><i class="fa fa-shopping-cart"></i>
										Cart</a></li>
								<li><a href="login.htm"><i class="fa fa-lock"></i>
										Login</a></li>
							</ul>
						</div>
					</div>
							...
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li class="dropdown"><a href="#">Shop<i
									...
									<ul role="menu" class="sub-menu">
										...
										<li><a href="product-details.htm" class="active">Product
												Details</a></li>
