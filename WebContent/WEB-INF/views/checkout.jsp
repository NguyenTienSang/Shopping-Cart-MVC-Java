		...
		<div class="container">
			...
			<div class="checkout-options">
				...
				<ul class="nav">
					...
					<li>
						<label><input type="checkbox">Thanh Toán Khách Hàng</label>
					</li>
					<li>
						...
						<div class="bill-to">
							...
							<div class="form-two">
								<form>
									...
									<input type="password" placeholder="Xác Nhận Tài Khoản">
									<input type="text" placeholder="Điện Thoại Bàn *">
									<input type="text" placeholder="Điện Thoại Di Động">
