	...
	<table class="table table-hover">
		...
		<c:forEach var="item" items="${listCategory}">
			<tr>
					<td>${item.id}</td>
					<td>${item.name}</td>
					<td><a href="${pageContext.request.contextPath}/admin/category/remove/${item.id}.htm">Remove</a></td>
					<td><a href="${pageContext.request.contextPath}/admin/category/edit/${item.id}.htm">Edit</a></td>
				</tr>
		</c:forEach>
	</table>
         </div>
