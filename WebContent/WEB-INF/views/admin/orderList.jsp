	...
	<table class="table table-hover">
		...
		<c:forEach var="item" items="${listOrDetail}">
			<tr>
					...
					<td>${item[4]}</td>
					<td>${item[5]}</td>
					<td><a href="${pageContext.request.contextPath}/admin/order/firm/${item[0]}.htm">Accept</a></td>
					<td><a href="${pageContext.request.contextPath}/admin/order/refuse/${item[0]}.htm">Refuse</a></td>
				</tr>
		</c:forEach>
	</table>
         </div>
